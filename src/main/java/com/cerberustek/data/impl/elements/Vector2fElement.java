...
public class Vector2fElement extends MetaElementImpl<Vector2f> {

    public Vector2fElement(Vector2f value) {
        super(value);
    }
    ...
    @Override
    public Vector2fTag toTag(String tag) {
        return new Vector2fTag(tag, get());
    }
    ...
    public boolean equals(Object obj) {
        ...
        assert obj instanceof Vector2fElement;
        return ((Vector2fElement) obj).get().equals(get());
    }
}
