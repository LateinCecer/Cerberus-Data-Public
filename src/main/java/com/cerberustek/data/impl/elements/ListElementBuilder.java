...
public class ListElementBuilder implements MetaBuilder<ListElement> {

    @Override
    public ListElement build(String tag, MetaInputStream inputStream) throws IOException, UnknownDiscriminatorException {
        int length = inputStream.readInt();
        ListElement<MetaData> output = new ListElement<>();
    ...
    @Override
    public ListElement build(String tag, MetaByteBuffer buffer) throws UnknownDiscriminatorException {
    ...
    @Override
    public Class<ListElement> getDataClass() {
