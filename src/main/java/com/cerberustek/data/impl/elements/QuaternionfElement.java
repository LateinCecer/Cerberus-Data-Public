...
import com.cerberustek.data.impl.tags.QuaternionfTag;
import com.cerberustek.exception.NoMatchingDiscriminatorException;
import com.cerberustek.logic.math.Quaternionf;

import java.io.IOException;

public class QuaternionfElement extends MetaElementImpl<Quaternionf> {

    public QuaternionfElement(Quaternionf value) {
        super(value);
    }
    ...
    @Override
    public QuaternionfTag toTag(String tag) {
        return new QuaternionfTag(tag, get());
    }
    ...
    public boolean equals(Object obj) {
        ...
        assert obj instanceof QuaternionfElement;
        return ((QuaternionfElement) obj).get().equals(get());
    }
}
