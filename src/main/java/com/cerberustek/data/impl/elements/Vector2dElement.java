...
import com.cerberustek.data.impl.tags.Vector2dTag;
import com.cerberustek.exception.NoMatchingDiscriminatorException;
import com.cerberustek.logic.math.Vector2d;

import java.io.IOException;

public class Vector2dElement extends MetaElementImpl<Vector2d> {

    public Vector2dElement(Vector2d value) {
        super(value);
    }
    ...
    @Override
    public Vector2dTag toTag(String tag) {
        return new Vector2dTag(tag, get());
    }
    ...
    public boolean equals(Object obj) {
        ...
        assert obj instanceof Vector2dElement;
        return ((Vector2dElement) obj).get().equals(get());
    }
}
