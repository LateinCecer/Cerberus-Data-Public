...
public class Vector3fElement extends MetaElementImpl<Vector3f> {

    public Vector3fElement(Vector3f value) {
        super(value);
    }
    ...
    @Override
    public Vector3fTag toTag(String tag) {
        return new Vector3fTag(tag, get());
    }
    ...
    public boolean equals(Object obj) {
        ...
        assert obj instanceof Vector3fElement;
        return ((Vector3fElement) obj).get().equals(get());
    }
}
