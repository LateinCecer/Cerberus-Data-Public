...
public class ArrayElementBuilder implements MetaBuilder<ArrayElement> {

    @Override
    public ArrayElement build(String tag, MetaInputStream inputStream) throws IOException, UnknownDiscriminatorException {
    ...
    @Override
    public ArrayElement build(String tag, MetaByteBuffer buffer) throws UnknownDiscriminatorException {
    ...
    @Override
    public Class<ArrayElement> getDataClass() {
