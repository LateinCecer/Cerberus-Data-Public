...
public class FloatTag extends FloatElement implements MetaTag {

    private String tag;

    public FloatTag(String tag, Float value) {
        super(value);
        this.tag = tag;
    }
    ...
    @Override
    public FloatElement toElement() {
        return new FloatElement(get());
    }
