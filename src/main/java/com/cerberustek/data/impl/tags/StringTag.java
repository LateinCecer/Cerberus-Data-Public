...
public class StringTag extends StringElement implements MetaTag {

    private String tag;

    public StringTag(String tag, String value) {
        super(value);
        this.tag = tag;
    }
    ...
    @Override
    public StringElement toElement() {
        return new StringElement(get());
    }
