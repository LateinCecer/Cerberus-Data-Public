...
public class BooleanTag extends BooleanElement implements MetaTag {

    private String tag;

    public BooleanTag(String tag, Boolean value) {
        super(value);
        this.tag = tag;
    }
    ...
    @Override
    public BooleanElement toElement() {
        return new BooleanElement(get());
    }
