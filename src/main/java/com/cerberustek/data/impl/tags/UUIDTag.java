...
public class UUIDTag extends UUIDElement implements MetaTag {

    private String tag;

    public UUIDTag(String tag) {
        this.tag = tag;
    }

    @Deprecated
    public UUIDTag(UUID value, String tag) {
        super(value);
        this.tag = tag;
    }

    public UUIDTag(String tag, UUID value) {
        super(value);
        this.tag = tag;
    }
    ...
    @Override
    public UUIDElement toElement() {
        return new UUIDElement(get());
    }
