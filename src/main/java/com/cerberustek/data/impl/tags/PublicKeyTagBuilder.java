...
import com.cerberustek.data.impl.elements.PublicKeyElementBuilder;
...
public class PublicKeyTagBuilder implements MetaBuilder<PublicKeyTag> {

    @SuppressWarnings("DuplicatedCode")
    @Override
    public PublicKeyTag build(String tag, MetaInputStream inputStream) throws IOException, UnknownDiscriminatorException {
        ...
        if (type == PrivateKeyElement.RSA) {
            ...
            return new PublicKeyTag(tag, PublicKeyElementBuilder.genRSAKey(modulus, exponent));
        } else {
            ...
            return new PublicKeyTag(tag, PublicKeyElementBuilder.genDSAKey(y, p, q, g));
        }
    }
    ...
    @SuppressWarnings("DuplicatedCode")
    @Override
    public PublicKeyTag build(String tag, MetaByteBuffer buffer) throws UnknownDiscriminatorException {
    ...
    @Override
    public Class<PublicKeyTag> getDataClass() {
        return PublicKeyTag.class;
    }
