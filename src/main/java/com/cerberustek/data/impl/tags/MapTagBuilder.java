...
public class MapTagBuilder implements MetaBuilder<MapTag> {

    @SuppressWarnings("Duplicates")
    @Override
    public MapTag build(String tag, MetaInputStream inputStream) throws IOException, UnknownDiscriminatorException {
        int length = inputStream.readInt();
        MapTag<MetaElement, MetaElement> output = new MapTag<>(tag);
    ...
    @SuppressWarnings("Duplicates")
    @Override
    public MapTag build(String tag, MetaByteBuffer buffer) throws UnknownDiscriminatorException {
    ...
    @Override
    public Class<MapTag> getDataClass() {
        return MapTag.class;
    }
