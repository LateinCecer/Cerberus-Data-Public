...
public class DoubleTag extends DoubleElement implements MetaTag {

    private String tag;

    public DoubleTag(String tag, Double value) {
        super(value);
        this.tag = tag;
    }
    ...
    @Override
    public DoubleElement toElement() {
        return new DoubleElement(get());
    }
