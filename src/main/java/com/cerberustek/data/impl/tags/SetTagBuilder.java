...
public class SetTagBuilder implements MetaBuilder<SetTag> {

    @Override
    public SetTag build(String tag, MetaInputStream inputStream) throws IOException, UnknownDiscriminatorException {
        int length = inputStream.readInt();
        SetTag<MetaData> set = new SetTag<>(tag);
    ...
    @Override
    public SetTag build(String tag, MetaByteBuffer buffer) throws UnknownDiscriminatorException {
    ...
    @Override
    public Class<SetTag> getDataClass() {
        return SetTag.class;
    }
