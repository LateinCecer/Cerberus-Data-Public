...
public class ContainerTag extends ContainerElement implements MetaTag {

    private String tag;

    public ContainerTag(String tag, byte[] values) {
        super(values);
        this.tag = tag;
    }
    ...
    @Override
    public ContainerElement toElement() {
        return new ContainerElement(get());
    }
