...
public class JSONTagInteger extends JSONInteger implements JSONTag {

    private String tag;

    public JSONTagInteger(String tag) {
        this.tag = tag;
    }

    public JSONTagInteger(String tag, int value) {
        super(value);
        this.tag = tag;
    }
