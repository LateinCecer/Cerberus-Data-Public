...
public class JSONTagString extends JSONString implements JSONTag {

    private String tag;

    public JSONTagString(String tag) {
        super();
        this.tag = tag;
    }

    public JSONTagString(String tag, String value) {
        super(value);
        this.tag = tag;
    }
    ...
    public MetaTag toMetaTag() {
        return new StringTag(tag, value);
    }
